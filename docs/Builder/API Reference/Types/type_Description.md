...
A description is a dictionary-array mix. The key of the array is either a property name (string) or a resolvable object. The value is usually another Instance, [``Descriptor``](../Descriptor/About.md), a [``State``](../State/About.md), or the value for the resolvable.
